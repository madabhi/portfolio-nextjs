...
const Projects = () => {
  return (
    <>
      <div
        className={` ${mont.variable} font-mont flex-grow-1 parent flex md:px-32 justify-center w-full min-h-full  flex-col mb-20`}
      >
        ...
        <div className="  grid grid-cols-1 h-full md:grid-cols-2 grid-flow-row gap-y-28 gap-x-28">
          <div className=" col-span-2">
            <div className="border-2 border-black h-[500px] rounded-[30px] relative  bg-light flex ">
              ...
              <div className="flex   w-full h-full  p-5 ">
                ...
                <div className="h-full w-1/2 flex flex-col gap-4 pl-4 justify-center">
          ...
          <div className=" ">
            <div className="border-2 border-black h-[520px] rounded-[30px] relative  bg-light flex ">
              <div className=" h-full rounded-[30px] bg-black -z-10 top-3 absolute w-full left-3"></div>
              <div className="flex   flex-col w-full h-full  p-5">
                <div className="relative h-full bg-light">
                  <MotionImage
                    src="/images/project1.png"
                    fill={true}
                    className="rounded-[15px] border-2 border-black "
                    sizes="{(max-width: 768px), width:100%, 400px}"
